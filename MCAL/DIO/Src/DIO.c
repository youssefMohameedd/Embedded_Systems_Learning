...
void Set_Port_Direction(DIO_Port Port_ID , uint8 Direction)
{
	switch(Port_ID)
	{
		case PA:	DDRA_REG = Direction;
					break;
		case PB:	DDRB_REG = Direction;
		break;
		case PC:	DDRC_REG = Direction;
					break;
		case PD:	DDRD_REG = Direction;
					break;
	}
}
...
void Write_Port(DIO_Port Port_ID , uint8 value)
{
	switch(Port_ID)
	{
		case PA:	PORTA_REG = value;
					break;
		case PB:	PORTB_REG = value;
					break;
		case PC:	PORTC_REG = value;
					break;
		case PD:	PORTD_REG = value;
					break;
	}
}
...
uint8 Read_Port(DIO_Port Port_ID)
{
	...
	switch(Port_ID)
	{
		case PA:	value = PINA_REG;
					break;
		case PB:	value = PINB_REG;
					break;
		case PC:	value = PINC_REG;
					break;
		case PD:	value = PIND_REG;
					break;
	}
	return value ;	
}
